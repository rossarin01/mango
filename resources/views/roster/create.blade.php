                        ...
                        <div class="container">
                                        ...
                                        <select name='roster_template' id="roster_template" class="select2-icons form-select roster_template" required>
                                            @if(!is_null($roster_templates))
                                                ...
                                                @foreach ($roster_templates as $template)
                                                    @if(!is_null($roster) && $roster->roster_template_id == $template->id)
                            ...
                            <div class="row mt-3">
                                <div class="col-6">
                                    ...
                                    <input type="text" name="roster_name" id="roster_name" value="{{ $roster->name ?? '' }}"
                                        class="form-control" placeholder="roster name" required>
                                </div>
                            </div>
                            <br>
                            <hr>
