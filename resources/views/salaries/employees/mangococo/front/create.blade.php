            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-header">
                        <a href="{{ route('salaries.employees.mangococo.front.index') }}" class="btn btn-primary">Back</a>
                            @if ($errors->any())
                        ...
                        <form action="{{ route('salaries.employees.mangococo.front.store') }}" method="POST">
                            @csrf
                                <div class="container">
                                    <div class="col-md-8">
                                    <div class="form-group">
                                            <label for="employees_id">Employee ID</label>
                                            <input type="text" name="employees_id" id="employees_id" class="form-control" placeholder="">
                                        </div>
                                        <br>
                                        <div class="form-group">
