    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-md-12">
                        <a href="{{ route('salaries.employees.mangococo.kitchen.index') }}" class="btn btn-primary">Back</a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="col-md-12">
                            <form action="{{ route('salaries.employees.mangococo.kitchen.update', $salary->id) }}" method="POST">
                                @csrf
                                @method('PUT')
